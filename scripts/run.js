...
const main = async () => {
  ...
  const [owner] = await ethers.getSigners();
    ...
    const st = ["A1","0","0","10","A2","1","1","5","B1","1","3","10"];
    ...
    let txn = await nftContract.createTickets("Metallica concert in Bzdziszewo!", "First concert of metallica in Bzdziszewo!", 1669492800, st );
    await txn.wait();
